var SLIDE_CONFIG = {
  ...
  settings: {
    ...
    eventInfo: {
      title: '2. Meilensteinpräsentation',
      date: '13.1.2015'
    },
    ...
    theme: ['fub'], // Add your own custom themes or styles in /theme/css. Leave off the .css extension.
  },

  // Author information
  presenters: [{
    name: 'Kain Kordian Gontarska, Lukas Benedix',
    company: 'FU Berlin',
    gplus: '',
    twitter: '',
    www: '',
